...
export async function sendInviteEmail(opts: {
  ...
  const roleLabel =
    intendedRole === "gestor" ? "Gestor" : intendedRole === "gestor_obras" ? "Gestor de Obras" : intendedRole === "projetista_gestor" ? "Projetista Gestor" : intendedRole === "executor" ? "Executor" : "Observador";
  const body = `
