...
| **gestor_obras** | Obras (aba Hoje) | Obras, Projetos, Calendário, Ajuda | Hub Obras: **Hoje** = 3 blocos na ordem do dia do gestor: **1 Visitas** (de hoje + obras pedindo visita c/ botão Agendar e nº de itens p/ checar lá; rodapé = próximas 7d) · **2 Cobre as pessoas** (tarefas vencidas POR RESPONSÁVEL → /tasks?responsavel=&vencidas=1 + planos c/ vencidos por obra) · **3 Datas para resolver** (estimadas passadas s/ final) ('Resumo do dia'/Fechar o dia REMOVIDO — muitas obras, não compensava; fechar-dia.tsx órfão de propósito; 'RDO' = só o arquivo da visita) · **Agenda** (cronológica por dia: Hoje/Amanhã/semana dia a dia + Mais adiante; visitas 30d + datas-chave 60d misturadas; só futuro) · **Pendências** (lista completa, WhatsApp p/ externos) · **Operação** (instalações/AT/amostras) |
